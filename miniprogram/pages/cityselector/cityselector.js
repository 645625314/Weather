...
Page({
	...
	onLoad: function (options) {
		...
		var html = '<button>haha</button>';
		WxParse.wxParse("html","html",html,this,0);
		wx.hideLoading();
		this.setData({
			province_list: ["上海","云南","内蒙古","北京","台湾","吉林","四川","天津","宁夏","安徽","山东","山西","广东","广西","新疆","江苏","江西","河北","河南","浙江","海南","湖北","湖南","澳门","甘肃","福建","西藏","贵州","辽宁","重庆","陕西","青海","香港","黑龙江"].sort(),
			isProvinceSelected: this.isProvinceSelected,
			isCitySelected: this.isCitySelected,
			isDistrictSelected: this.isDistrictSelected,
			province: this.province,
